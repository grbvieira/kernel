...
ARCH		?= $(SUBARCH)
ARCH            ?= arm64
CROSS_COMPILE	?=home/noosreg/toolchain/gcc-cfp/gcc-cfp-jopp-only/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC              =/home/noosreg/kernel-N986B/toolchain/clang/host/linux-x86/clang-r349610-jopp/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
