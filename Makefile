...
CC              = $(srctree)/toolchain/clang/host/linux-x86/clang-r416183b/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
CLANG_TRIPLE	?= $(srctree)/toolchain/clang/host/linux-x86/clang-r416183b/bin/aarch64-linux-gnu-
